        ...
        <section className='pt-8 pb-40'>
            <div className="container">
                <div className="text-center border-b border-white">
                    <h2 className='text-center font-impact text text-[326px] leading-none  tracking-[10px] select-none group'>
                        <span className='text-[#FFF5DE] group-hover:text-[#FCA311] transition duration-500'>Serv</span>
                        <span className='text-[#FCA311] group-hover:text-[#FFF5DE] duration-500'>ices</span>
                    </h2>
                </div>
