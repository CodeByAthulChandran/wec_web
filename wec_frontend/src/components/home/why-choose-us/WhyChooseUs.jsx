      ...
      <div className="px-10">
        <div className="flex gap-4 py-10">
          <div className="left-section relative  bg-black w-2/3 rounded-[35px] px-8">
            <div className="group">
              <h5 className="text-white font-impact text-[400px] leading-none group-hover:translate-x-[76%] z-30 transition-all duration-200">
                Why
              </h5>
            ...
            <h6 className="text-white font-workSans text-[220px] font-[300] leading-none">
              Choose
            </h6>
          </div>
          <div className="right-section w-1/3  bg-black rounded-[35px] flex items-center flex-col  justify-end group">
            <h6 className="text-primary font-workSans text-[220px] px-8 font-[300] leading-none ">
              us
              <span className="text-white font-workSans text-[220px] font-[300]">
                ?
              </span>
            </h6>
          </div>
        ...
        {/* row-2 */}
        <div className="mt-6 overflow-hidden bg-[#FFF5DE] rounded-[35px] px-2">
          <div className="flex items-start justify-between flex-wrap w-full font-impact text-[167px] leading-none !uppercase tracking-[-2px]">
            <span className="text-primary">we offer</span>
            <span>a complete</span>
            <br />
            <span>range of services to</span>
            <span>meet all your</span>
            <br />
